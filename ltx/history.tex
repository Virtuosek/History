...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/oxfordLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/harvardLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/c&aLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/LouisVuittonLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=7cm]{./img/fordLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/rolexLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/tripleEntente.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/FBILogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=2cm]{./img/gucciLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/adidasLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=10cm]{./img/nissanLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/lacosteLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/raybanLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=12cm]{./img/mcdonaldsLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/unicefLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=3.5cm]{./img/pakistanFlag.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/CIALogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/pumaLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=4cm]{./img/legoLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=3cm]{./img/NSALogo.png}\end{center}
...
The Lord of the Rings is composed of six "books", aside from an introduction, a prologue and six appendices. The novel was originally published as three separate volumes due to post-World War II paper shortages and size and price considerations.[2] The Two Towers covers Books III and IV.\\
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/bandaiNamcoLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/nasaLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/jfk.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/nikeLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=8cm]{./img/primarkLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/microsoftLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=8cm]{./img/dolce&gabannaLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=10cm]{./img/swatchLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=10cm]{./img/fromSoftwareLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=7cm]{./img/europeFlag.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/yahooLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=8cm]{./img/amazonLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=8cm]{./img/coplogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/ebayLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=10cm]{./img/valveLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/paypalLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/steamLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=2cm]{./img/facebookLogo.png}\end{center}
...
\begin{center}\includegraphics[width=10cm]{./img/youtubeLogo.png}\end{center}
...
\vspace{2mm}\begin{center}\includegraphics[width=6cm]{./img/discordLogo.png}\end{center}
