...
\vspace{2mm}\begin{center}\includegraphics[width=10cm]{./img/organiclife.jpg}\end{center}
...
[\vspace{2mm}\begin{center}\includegraphics[width=5cm]{./img/lotrbook2.jpg}\end{center}
...
Primark opened its current international headquarters in 2015 in a redeveloped Dublin building, Arthur Ryan House, formerly Chapel House.
...
\section{July 20}
\subsection{Apollo 11 (first human landing on the Moon)}
...
\subsection{Voyager 1 exiting the Solar-System}
